...
An exception is DeepSignal [@doi:10.1093/bioinformatics/btz276], which is a CNN that uses contextual electrical signals from Nanopore sequencing to predict 5mC or 6mA DNA methylation status.
