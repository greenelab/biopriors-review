...
(TODO: an intro/blurb about how a model might be constrained by its sequence)
...
DeepSignal [@doi:10.1093/bioinformatics/btz276] is a CNN that uses contextual electrical signals from Nanopore single-molecule sequencing data to predict 5mC or 6mA DNA methylation status.
...
* 10.1093/bioinformatics/bty554 (off-target blah blah)
